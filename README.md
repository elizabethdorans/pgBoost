...
<ins>NOTE</ins>: 
- When SCENT, follow all instructions marked \*** to skip the p-value calculation (not needed for pgBoost input). This will save time and computational resources.
